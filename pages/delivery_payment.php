...
<body style="background-color: rgb(235, 238, 247);">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="#">Доставка/Оплата</a>
        </li>
  ...
  <path d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 6h1.717L5.07 1.243a.5.5 0 0 1 .686-.172zM2.468 15.426.943 9h14.114l-1.525 6.426a.75.75 0 0 1-.729.574H3.197a.75.75 0 0 1-.73-.574z"/>
    ...
    <div class="container-fluid">
      <h3 class="text-center">Доставка/Оплата</h3>
      <br>
      <p>Просим обратить внимание, что 07.01.2022 курьерская доставка и доставка на отделения службами «Нова пошта» и «Meest Express» не осуществляется.</p>
      <p>При заказе с доставкой курьером Новой Почты или курьером Meest Express на сумму свыше 400 грн — доставка бесплатно.</p>
      <p>При заказе с доставкой курьером Новой Почты на сумму менее 400 грн — стоимость доставки 59 грн.</p>
      <p>При заказе с доставкой курьером Meest Express на сумму менее 400 грн — стоимость доставки 39 грн. При заказе с доставкой курьером Новой Почты или Meest Express на сумму свыше 1000 грн — доставка бесплатно.</p>
    </div>
