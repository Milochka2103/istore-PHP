...
<body style="background-color: rgb(235, 238, 247);">
  ...
  <div class="container-fluid">
    ...
    <br>
    <p>Chocoladochka - бренд натуральных сладостей, которые производит кондитерская фабрика "Кусь-кусь" (г. Мечта, Украина).</p>
    <p>Он был создан несколько лет назад людьми, которые любят и знают свое дело, и с тех пор мы ни на шаг не отступаем от нашей миссии - предлагать взрослым и детям только натуральную, качественную и вкусную продукцию.</p>
    <p>На сегодняшний день ассортимент продукции Chocoladochka достаточно большой, при этом мы не стоим на месте и постоянно ищем новые, интересные пути развития. На фабрике существует 5 основных направлений производства: шоколадные плитки, конфеты, печенье, торты и пироженые.</p>
  </div>
