    ...
    <div class="col-sm">
      <div style="display: flex; justify-content: left; align-items: left;">
        <form style="width: 400px;" method="post" action="../includes/sign_in.php">
          <h2>Приветствую, <?= $_SESSION['user']['full_name'] ?></h2>
          <p><?= $_SESSION['user']['email'] ?></p>
        </form>
      </div>
    </div>
    <div class="col-sm">
      <a href="../includes/log_out.php" style="display: flex; justify-content: right; align-items: right; color: black; font-weight: bold;">Выход</a>
    </div>
  </div>
</div>
