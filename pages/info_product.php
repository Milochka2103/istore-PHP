...
<div class="tab-content">
  <div class="tab-pane fade show active" id="description">
    <div id="wrapper">
      ...
      $article = mysqli_query($connection, "SELECT * FROM `card_product` WHERE `id` = " . (int) $_GET['id']);
      ?>
      <?php
      $product = mysqli_fetch_assoc($article);
      ?>
      <div id="content">
              ...
              <div class="block">
                  <div class="block__content">
                      <table class="table table-bordered">
                        ...
                        <thead>
                          <tr>
                            <th scope="col" class="text-center">Состав</th>
                          </tr>
                          <tr>
                            <th scope="row" class="text-center"><?php echo $product['ingridients']; ?></th>
                          </tr>
                        </thead>
                      </table>
                      <h5 class="text-center">Энергетическая ценность</h5>
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">Калорийность, кКал</th>
                            <td>310,8</td>
                          </tr>
                          <tr>
                            <th scope="row">Белки, гр</th>
                            <td>6,8</td>
                          </tr>
                          <tr>
                            <th scope="row">Углеводы, гр</th>
                            <td>36</td>

                          </tr>
                          <tr>
                            <th scope="row">Жиры, гр</th>
                            <td>15,5</td>
                          </tr>
                        </tbody>
                      </table>
