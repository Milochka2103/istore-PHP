...
<body style="background-color: rgb(235, 238, 247);">
 ...
 <?php 
    $categor = mysqli_query($connection, "SELECT * FROM `card_product` WHERE `categories_id`=1 ORDER BY `price`");
    ?>
      ...
      ?>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="korzina.php" data-art="<?php echo $product['id'] ?>" class="btn btn-outline-dark btn-buy" id="1">Купить</a>
          </div>
        </div>
      </div>
      <?php
