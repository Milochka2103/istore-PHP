...
<body style="background-color: rgb(235, 238, 247);">
  ...
  <div style="display: flex; justify-content: center; align-items: center; margin-top: 120px;">
    <form style="width: 400px;" method="post" action="../includes/sign_in.php">
      ...
      <br>
      <button type="submit" class="btn btn-success" style="">Войти</button>
      <div class="login-links">
        <br>
        <p class="text-center">У Вас нет аккаунта? <a class="txt-brand" href="registr.php"><font color=#29aafe>Зарегистрироваться</font></a></p>
      </div>
      <?php
          if ($_SESSION['message']) {
